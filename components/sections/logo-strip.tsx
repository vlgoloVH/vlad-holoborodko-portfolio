...
export function LogoStrip() {
  ...
  return (
    <div className="relative -mx-8 md:-mx-14">
      <section className="flex flex-col justify-center border-y border-line py-2 md:block md:py-8">
          ...
          <div className="flex w-max items-center animate-[scroll_50s_linear_infinite] gap-3 motion-reduce:animate-none md:gap-10">
            {[...LOGOS, ...LOGOS].map((logo, i) => {
              ...
              return (
                <div
                  key={`${logo}-${suffix}-${i}`}
                  className="relative h-7 w-[80px] flex-shrink-0 transition-opacity duration-300 hover:opacity-70 md:h-14 md:w-[140px]"
                >
                  <Image
                    src={imagePath}
                    alt={logo}
