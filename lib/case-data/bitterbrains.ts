...
export const bitterbrainsData: CaseData = {
  ...
  reflection: {
    insights: [
      {
        number: "01",
        insight: "Being the first designer at a growing company means you don't just design products. You build the design culture, the visual language, and the standard that everything after you is measured against.",
      },
      {
        number: "02",
        insight: "Designing for developers taught me that the people who notice every detail the most are also the most appreciative when you get it right. Technical audiences reward craft.",
      },
      {
        number: "03",
        insight: "When you work across 15 products over six years, consistency becomes your most important design skill. Not visual consistency, but conceptual consistency. The same thinking, applied everywhere.",
      },
    ],
  },
};
