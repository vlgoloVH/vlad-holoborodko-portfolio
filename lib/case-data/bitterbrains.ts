...
export const bitterbrainsData: CaseData = {
  ...
  reflection: {
    insights: [
      ...
      {
        number: "03",
        insight: "When you work across 15 products over six years, consistency becomes your most important design skill. Not visual consistency — conceptual consistency. The same thinking, applied everywhere.",
      },
    ],
  },
};
