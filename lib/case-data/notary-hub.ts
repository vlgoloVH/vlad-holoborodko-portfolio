...
export const notaryHubData: CaseData = {
  ...
  context: {
    ...
    outcome: "A complete, MISMO-compliant RON product — a responsive web platform (PWA) where consumers, notaries, and companies notarize documents online, and the internal back-office system that runs it all. Today NotaryHub is known as one of the most accessible and easy-to-use RON platforms in the US.",
  },
  role: {
    summary: "I designed the entire NotaryHub product — every screen of the responsive web platform, plus the internal back-office that runs it. I owned the experience for all three sides of the client platform — consumers, notaries, and companies — and the admin system the team uses to manage users, sessions, and compliance data behind the scenes.",
  ...
  overviewTagline: "One product. Client platform and internal back-office system.",
  transformation: [
    {
  ...
  impact: {
    items: [
      ...
      { value: "PWA", label: "Responsive web app", body: "A single web platform (PWA) that adapts seamlessly from desktop to mobile." },
