...
export const spaceNeedleData: CaseData = {
  ...
  role: {
    ...
    summaryExtra: "Across the engagement I worked on six distinct products serving three very different audiences: tourists experiencing the tower for the first time, on-site staff handling ticketing and sales, and operations managers controlling pricing, inventory, and scheduling across all channels. Each product had its own context, constraints, and success criteria — and all of them had to work together as a single coherent ecosystem. Beyond Space Needle itself, the same design foundations were adapted for two partner attractions — Chihuly Garden and Glass and Seattle Top Tix — which added another layer of complexity around brand flexibility and shared component architecture.",
