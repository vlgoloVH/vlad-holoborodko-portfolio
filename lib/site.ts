...
export const METRICS = [
  ...
  { value: 6, suffix: "", label: "Industries shaped" },
  { value: 24, suffix: "", label: "Products shipped" },
  { value: 3, suffix: "", label: "Teams built from 0→1" },
];
